...
public class MdcAdapterInitializer {
    ...
    /**
     * Initializes the MDC implementation for SLF4J. If no MDC adapter is set or if the current adapter is a
     * NOPMDCAdapter, it sets the MDC adapter to a BasicMDCAdapter instance.
     */
